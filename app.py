...
def get_conversational_chain(api_key):
    ...
    If the answer is not explicitly stated in the context, use your best judgment based on the information provided. 
    If the answer is not in the provided context, simply state, "The answer is not available in the context."
